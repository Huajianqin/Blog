...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '极华Geekhua', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '记录学习与探索的脚步，分享技术与创意的碰撞，书写成长与梦想的篇章！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.geekhua.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '极华,Geekhua,博客,记录,分享,技术,教程,探索,成长,创意', // 网站关键词 英文逗号隔开
